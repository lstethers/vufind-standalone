...
/* VUFINDLOCALONLY - BEGIN - add libary and location to the record driver data formatting view helper*/
		$spec->setLine('Library', 'getLibrary');
		$spec->setLine('Location', 'getLocation');
/* VUFINDLOCALONLY - END - add libary and location to the record driver data formatting view helper*/
        $spec->setTemplateLine('Series', 'getSeries', 'data-series.phtml');
        $spec->setTemplateLine(
            'Subjects', 'getAllSubjectHeadings', 'data-allSubjectHeadings.phtml'
        );
